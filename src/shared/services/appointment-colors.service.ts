  ...
  private readonly colorOptions: ColorOption[] = [
    {
      ...
      darkBackgroundClass: "dark:bg-blue-900/30",
    ...
    },
    {
      ...
      darkBackgroundClass: "dark:bg-green-900/30",
    ...
    },
    {
      ...
      darkBackgroundClass: "dark:bg-red-900/30",
    ...
    },
    {
      ...
      darkBackgroundClass: "dark:bg-yellow-900/30",
    ...
    },
    {
      ...
      darkBackgroundClass: "dark:bg-purple-900/30",
    ...
    },
    {
      ...
      darkBackgroundClass: "dark:bg-indigo-900/30",
    ...
    },
    {
      ...
      darkBackgroundClass: "dark:bg-pink-900/30",
    ...
    },
    {
      ...
      darkBackgroundClass: "dark:bg-gray-700/40",
    ...
    },
    {
      ...
      darkBackgroundClass: "dark:bg-emerald-900/30",
    ...
    },
    {
      ...
      darkBackgroundClass: "dark:bg-orange-900/30",
