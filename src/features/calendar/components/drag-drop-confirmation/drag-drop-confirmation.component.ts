        ...
        @if (confirmationData()) {
          <div class="space-y-4">
              ...
              @if (confirmationData()!.changes.timeChanged) {
                <div class="flex items-center text-sm mb-1">
                  ...
                  <span class="text-gray-600 dark:text-gray-300">
                    Time: {{ formatTime(confirmationData()!.appointment.startTime) }} - {{ formatTime(confirmationData()!.appointment.endTime) }}
                    →
                    {{ formatTime(confirmationData()!.newStartTime) }} - {{ formatTime(confirmationData()!.newEndTime) }}
                  </span>
                </div>
              }
            ...
            <div class="text-sm text-gray-600 dark:text-gray-400">
              ...
              <div class="flex justify-between">
                <span>Duration:</span>
                <span>{{ calculateDuration(confirmationData()!.newStartTime, confirmationData()!.newEndTime) }} minutes</span>
              </div>
            </div>
